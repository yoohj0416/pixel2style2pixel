...
from datasets.images_dataset import *
...
class Coach:
    ...
    def configure_datasets(self):
        ...
        if self.opts.dataset_type == 'tooth_inpainting':
            train_dataset = ImagesDatasetToothInpainting(source_root=dataset_args['train_source_root'],
                                                         target_root=dataset_args['train_target_root'],
                                                         source_transform=transforms_dict['transform_source'],
                                                         target_transform=transforms_dict['transform_gt_train'],
                                                         opts=self.opts,
                                                         flip=self.opts.horizontal_flip)
            test_dataset = ImagesDatasetToothInpainting(source_root=dataset_args['test_source_root'],
            ...
            train_dataset = ImagesDatasetWithOpposing(prepare_root=dataset_args['train_prepare_root'],
                                                      ...
                                                      opts=self.opts,
                                                      flip=self.opts.horizontal_flip)
            test_dataset = ImagesDatasetWithOpposing(prepare_root=dataset_args['test_prepare_root'],
